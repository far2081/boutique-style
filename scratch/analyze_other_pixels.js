...
for (let i = 0; i < img.pixels.length; i += 4) {
    ...
    countOther++;
    if (otherExamples.length < 50) {
        const y = Math.floor((i / 4) / img.width);
        const x = (i / 4) % img.width;
        otherExamples.push({ x, y, r, g, b });
    }
}

console.log('Total pixels:', countTotal);
console.log('Background pixels:', countBackground);
console.log('Clothing pixels:', countClothing);
console.log('Skin pixels:', countSkin);
console.log('Other pixels:', countOther);
console.log('First 50 other pixels:');
console.log(otherExamples);
