...
console.log('Skin Pixels stats:');
console.log('  Count:', countSkin);
console.log('  Avg R:', sumR / countSkin);
console.log('  Avg G:', sumG / countSkin);
console.log('  Avg B:', sumB / countSkin);
console.log('  Min R, G, B:', minR, minG, minB);
